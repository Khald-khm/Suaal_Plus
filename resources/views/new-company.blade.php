            ...
            <div class="card-body">
                <form class="form-horizontal form-material" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text2" name="name" class="form-control form-control-line" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text2" name="phone" class="form-control form-control-line" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text2" name="whats_app" class="form-control form-control-line" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text2" name="facebook" class="form-control form-control-line" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text2" name="telegram" class="form-control form-control-line" required>
                        </div>
                    </div>
...
-->
    ...
    <div class="form-group" >
        ...
        <button type="submit" class="form-control-submit-button" href="/profile" id="addB">إضافة
        </button>
    </div>
</form>
    <br>
