    ...
    <div class="head">
        ...
        <div class="containerpage">
            ...
            <div class="tab-pane" id="settings" role="tabpanel">
                <div class="card-body">
                    <form class="form-horizontal form-material" action="/newAdmin" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text2" name="first_name" class="form-control form-control-line" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text2" name="last_name" class="form-control form-control-line" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text2" name="email" class="form-control form-control-line" required>
                            </div>
                        </div>
